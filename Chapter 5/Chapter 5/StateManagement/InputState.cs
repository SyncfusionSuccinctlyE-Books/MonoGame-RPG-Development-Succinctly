...
namespace MonoGameRPG.StateManagement
{
    ...
    public class InputState
    {
        ...
        private readonly MouseState[] lastMouseState;
        ...
        public bool IsNewMouseClick(MouseButtons button)
        {
            switch(button)
            {
                case MouseButtons.Left:
                    ...
                    return CurrentMouseState[0].LeftButton == ButtonState.Pressed && lastMouseState[0].LeftButton == ButtonState.Released;

                case MouseButtons.Middle:

                    return CurrentMouseState[0].MiddleButton == ButtonState.Pressed && lastMouseState[0].MiddleButton == ButtonState.Released;

                case MouseButtons.Right:

                    return CurrentMouseState[0].RightButton == ButtonState.Pressed && lastMouseState[0].RightButton == ButtonState.Released;
            }
